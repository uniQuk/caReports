...
function Get-GroupDetails {
    ...
    try {
        ...
        $members = Invoke-MgGraphRequest -Method GET -Uri "https://graph.microsoft.com/v1.0/groups/$groupId/members"
        
        # Transform members to match user format
        $formattedMembers = @{}
...
# Add function to get application details
...
# Modified function to reorder policy properties
